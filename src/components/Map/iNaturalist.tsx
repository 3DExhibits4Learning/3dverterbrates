                                            ...
                                            <Popup>
                                                <div className='flex h-[200px] w-[300px] justify-between'>
                                                    <div>
                                                        ...
                                                        <p className='text-[14px] !m-0 hover:underline hover:cursor-pointer'><div className=' relative h-[24px] w-[24px] mr-1'><Image src='/messageIcon.png' alt='Message Icon' fill></Image></div>Message {observation.user.login}</p>
                                                    </div>
