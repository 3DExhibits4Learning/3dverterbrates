            ...
            <div className="flex w-1/2 rounded-lg overflow-hidden">
                <table className="w-full bg-[#D5CB9F]">
                    <tr>
                        ...
                        <th className="text-xl border-b border-[#004C46] border-r py-4">Marked as annotated</th>
                        ...
                        sam.map((student, index) =>
                            <>
                                <tr>
                                    ...
                                    <td className={index === sam.length - 1 ? "py-2 pl-2 border-r border-[#004C46]" : "border-b border-[#004C46] border-r py-2 pl-2"} key={Math.random()}>{student.assignment.length ? student.models[0].spec_name : ''}</td>
                                    <td className={index === sam.length - 1 ? "py-2 pl-2 border-r border-[#004C46]" : "border-b border-[#004C46] border-r py-2 pl-2"} key={Math.random()}>{student.assignment.length ? student.models[0].annotated : ''}</td>
                                    <td className={index === sam.length - 1 ? "py-2 pl-2 border-r border-[#004C46]" : "border-b border-[#004C46] border-r py-2 pl-2"} key={Math.random()}>{student.assignment.length ? student.models[0].annotationsApproved : ''}</td>
