...
export default async function Page() {
    ...
    return (
        <>
            ...
            <ModelSubmitForm token={process.env.SKETCHFAB_API_TOKEN as AxiosHeaderValue} email={session.user.email as string} isSketchfabLinked={isSketchfabLinked() as boolean} />
            <Foot />
        </>
    )
}